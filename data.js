...
const EQUIPMENT_POOL = [
  ...
  },
  {
    ...
    skill: {
      ...
      name: "냉기 폭발",
      icon: "❄️",
      desc: "범위 피해 + 3초간 이동속도 50% 감소",
      cdMax: 9,
      dmgMult: 2.6,
      radius: 190,
      vfx: "w_frost_burst",
      groundVfx: "w_frost_ground",
    },
  },
  {
    id: "steel_bow",
    ...
    skill: {
      ...
      name: "관통 사격",
      icon: "🏹",
      desc: "직선상의 적을 모두 관통 타격",
      cdMax: 6,
      dmgMult: 2.0,
      radius: 480,
      vfx: "w_piercing_arrow",
    },
  },
  {
    id: "dragon_fang",
  ...
  },
  {
    ...
    skill: {
      name: "철벽",
      icon: "🛡️",
      desc: "피격 시 25% 확률로 피해 40% 감소 (패시브)",
      passiveOnly: true,
      vfx: "passive_shield_spark",
    },
  },
  {
    id: "shadow_robe",
  ...
  },
  {
    ...
    skill: {
      name: "흡혈",
      icon: "📿",
      desc: "공격 시 피해량의 4%만큼 체력 흡수 (패시브)",
      passiveOnly: true,
      vfx: "passive_lifesteal",
    },
  },
  {
    id: "mana_bracelet",
...
const PET_POOL = [
  ...
  },
  {
    ...
    icon: "🐺",
    rarity: "epic",
    desc: "주변 적을 지속적으로 감속시키고 피해를 입히는 냉기 오라",
    type: "aura",
    radius: 130,
    dmgPerSec: 4,
  },
...
const APPEARANCE_POOL = [
  {
    ...
    name: "대검사",
    icon: "⚔️",
    file: "sprites/warrior.png",
    sprite: "image/player/warrior.png",
    portrait: "image/portrait/warrior.png",
  },
  {
    id: "mage",
    name: "마법사",
    icon: "🔮",
    file: "sprites/mage.png",
    sprite: "image/player/mage.png",
    portrait: "image/portrait/mage.png",
  },
  {
    id: "rogue",
    name: "도적",
    icon: "🗡️",
    file: "sprites/rogue.png",
    sprite: "image/player/rogue.png",
    portrait: "image/portrait/rogue.png",
  },
  {
    id: "cleric",
    name: "성기사",
    icon: "📿",
    file: "sprites/cleric.png",
    sprite: "image/player/cleric.png",
    portrait: "image/portrait/cleric.png",
  },
];
...
// ---------------------------------------------------------------------
const VFX = {
  slime_king_land_splash:
    "image/effects_boss_20260914/slime_king_land_splash.png",
  slime_king_ring_texture:
    "image/effects_boss_20260914/slime_king_ring_texture.png",
...
const VFX_ANIM = {
  q_fire_explosion: [1, 2, 3, 4].map(
    (i) => `image/vfx2/q_fire_explosion_0${i}.png`,
  ),
  q_fire_ground: [1, 2, 3].map((i) => `image/vfx2/q_fire_ground_0${i}.png`),
  e_meteor_explosion: [1, 2, 3, 4].map(
    (i) => `image/vfx2/e_meteor_explosion_0${i}.png`,
  ),
  r_lightning_spark: [1, 2, 3, 4].map(
    (i) => `image/vfx2/r_lightning_spark_0${i}.png`,
  ),
};
...
const CLASS_KITS = {
  warrior: {
    basicAttack: {
      ...
      dmgMult: 1.6,
      label: "대검 휘두르기",
      desc: "느리지만 전방 부채꼴 범위를 베는 근접 공격",
      vfx: "attack_sword_swoosh",
      castFraction: 0.35,
    },
    qSkill: {
      id: "warriorQ",
  ...
  mage: {
    basicAttack: {
      ...
      speed: 620,
      label: "마력탄 발사",
      desc: "가장 가까운 적에게 마력탄을 발사하는 원거리 공격",
      vfx: "attack_arcane_bolt",
      castFraction: 0.45,
    },
    qSkill: {
      id: "mageQ",
      ...
      vfx: "q_fireball",
      vfxAnim: "q_fire_explosion",
      groundVfxAnim: "q_fire_ground",
    },
  },
  rogue: {
    basicAttack: {
      ...
      dmgMult: 0.55,
      label: "빠른 찌르기",
      desc: "사거리는 짧지만 매우 빠르게 연타하는 근접 공격",
      vfx: "attack_dagger_spark",
      castFraction: 0.2,
    },
    qSkill: {
      id: "rogueQ",
  ...
  cleric: {
    basicAttack: {
      ...
      dmgMult: 0.9,
      label: "성스러운 파동",
      desc: "느리지만 주변의 모든 적을 타격하는 광역 공격",
      vfx: "attack_holy_ring",
      castFraction: 0.3,
    },
    qSkill: {
      id: "clericQ",
...
const MONSTER_TYPES = {
  poison_slime: {
    name: "독 슬라임",
    walk: "image/poison_slime_20260914/walk_strip_256.png",
    attack: "image/poison_slime_20260914/attack_strip_256.png",
  },
  skeleton_archer: {
    name: "스켈레톤 궁병",
    walk: "image/skeleton_archer_20260914/walk_strip_256.png",
    attack: "image/skeleton_archer_20260914/attack_strip_256.png",
  },
  tree: {
    name: "나무 몬스터",
    walk: "image/tree_monster_20260914/walk_strip_256.png",
    attack: "image/tree_monster_20260914/attack_strip_256.png",
  },
  slime: {
    name: "슬라임",
    walk: "image/slime_walk_strip_256.png",
    attack: "image/slime_attack_strip_256.png",
  },
  bat: {
    name: "박쥐",
    walk: "image/bat_walk_strip_256.png",
    attack: "image/bat_attack_strip_256.png",
  },
  goblin: {
    name: "고블린",
    walk: "image/goblin_walk_strip_256.png",
    attack: "image/goblin_attack_strip_256.png",
  },
  skeleton: {
    name: "스켈레톤",
    walk: "image/skeleton_walk_strip_256.png",
    attack: "image/skeleton_attack_strip_256.png",
  },
  demon_archer: {
    name: "마족 궁수",
    walk: "image/monsters_ready_20260914/demon_archer/walk_strip_256.png",
    attack: "image/monsters_ready_20260914/demon_archer/attack_strip_256.png",
  },
  fallen_mace: {
    name: "타락한 철퇴병",
    walk: "image/monsters_ready_20260914/fallen_mace/walk_strip_256.png",
    attack: "image/monsters_ready_20260914/fallen_mace/attack_strip_256.png",
  },
  demon_warrior: {
    name: "마족 전사",
    walk: "image/monsters_ready_20260914/demon_warrior/walk_strip_256.png",
    attack: "image/monsters_ready_20260914/demon_warrior/attack_strip_256.png",
  },
  corrupt_official: {
    name: "탐관오리",
    walk: "image/monsters_ready_20260914/corrupt_official/walk_strip_256.png",
    attack:
      "image/monsters_ready_20260914/corrupt_official/attack_strip_256.png",
  },
  demon_slime: {
    name: "악마 슬라임",
    walk: "image/monsters_ready_20260914/demon_slime/walk_strip_256.png",
    attack: "image/monsters_ready_20260914/demon_slime/attack_strip_256.png",
  },
  succubus: {
    name: "서큐버스",
    walk: "image/monsters_ready_20260914/succubus/walk_strip_256.png",
    attack: "image/monsters_ready_20260914/succubus/attack_strip_256.png",
  },
};

function stageMonsterPool(stage, progress = 1) {
  if (stage <= 1)
    return progress >= 0.5 ? ["slime", "slime", "tree"] : ["slime", "slime"];
...
const BOSS_TIERS = [
  { id: "slime_king", name: "슬라임 왕", hp: 0.7, speed: 48 },
  { id: "bat_queen", name: "박쥐 여왕", hp: 0.8, speed: 80 },
  { id: "goblin_bomber", name: "고블린 폭탄왕", hp: 0.9, speed: 64 },
...
BOSS_TIERS.forEach((b) => {
  b.file = `image/boss_expansion_20260912/${b.id}.png`;
});
